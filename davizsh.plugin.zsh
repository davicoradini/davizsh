...
alias cdzman='cd ~/PycharmProjects/zanzarguias-management-app-web'
alias cdzand='cd ~/AndroidStudioProjects/ZanzarGuias'
...
alias cdqlan='cd ~/PycharmProjects/quiteja-landing-page/'
